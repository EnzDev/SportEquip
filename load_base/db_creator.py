...
for iterator_installation in fichier_installation['data']:
    ...
    conn.commit()
    ligne = {"InsNumeroInstall":  iterator_installation["InsNumeroInstall"], "Latitude" :    float(iterator_installation["Latitude"]), "Longitude" :    float(iterator_installation["Longitude"]), "InsCodePostal" :   iterator_installation["InsCodePostal"], "Nom" :   iterator_installation["geo"]["name"], "InsLibelleVoie" :   iterator_installation["InsLibelleVoie"], "ComLib" :   iterator_installation["ComLib"]}
